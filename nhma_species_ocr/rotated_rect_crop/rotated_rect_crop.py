...
def crop_rotated_rectangle(image, rect, shrink_border = 0):
    ...
    return rotated_rect_bbx_upright_image[int(crop_center[1]-rect_height//2+shrink_border) : int(crop_center[1]+(rect_height-rect_height//2)-shrink_border), int(crop_center[0]-rect_width//2+shrink_border) : int(crop_center[0]+(rect_width-rect_width//2-shrink_border))]