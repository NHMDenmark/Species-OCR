    ...
    for paragraph in full_paragraphs:
        ...
        if highest_classification_level:
            if (
                ...
                and classification_gbif[highest_classification_level] != ""
            ):
                if (
                    classification[highest_classification_level].lower()
                    == classification_gbif[highest_classification_level].lower()
                ):
